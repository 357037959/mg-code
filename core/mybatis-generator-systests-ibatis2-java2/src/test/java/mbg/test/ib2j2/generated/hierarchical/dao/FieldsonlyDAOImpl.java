...
public class FieldsonlyDAOImpl implements FieldsonlyDAO {
     ...
     * @mbg.generated Sat Mar 25 03:13:53 CST 2017
     */
    public long countByExample(FieldsonlyExample example) throws SQLException {
        Long count = (Long)  sqlMapClient.queryForObject("FIELDSONLY.countByExample", example);
     ...
     * @mbg.generated Sat Mar 25 03:13:53 CST 2017
     */
    public List selectByExample(FieldsonlyExample example) throws SQLException {
        List list = sqlMapClient.queryForList("FIELDSONLY.selectByExample", example);
        return list;
    }
