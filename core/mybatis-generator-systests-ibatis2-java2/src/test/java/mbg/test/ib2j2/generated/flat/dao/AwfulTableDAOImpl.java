...
public class AwfulTableDAOImpl implements AwfulTableDAO {
     ...
     * @mbg.generated Sat Mar 25 03:13:53 CST 2017
     */
    public long countByExample(AwfulTableExample example) throws SQLException {
        Long count = (Long)  sqlMapClient.queryForObject("awful table.countByExample", example);
