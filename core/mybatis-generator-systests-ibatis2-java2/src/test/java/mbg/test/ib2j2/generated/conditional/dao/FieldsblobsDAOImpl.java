...
public class FieldsblobsDAOImpl extends SqlMapClientDaoSupport implements FieldsblobsDAO {
     ...
     * @mbg.generated Sat Mar 25 03:13:53 CST 2017
     */
    public long countByExample(FieldsblobsExample example) {
        Long count = (Long)  getSqlMapClientTemplate().queryForObject("FIELDSBLOBS.countByExample", example);
     ...
     * @mbg.generated Sat Mar 25 03:13:53 CST 2017
     */
    public List selectByExampleWithBLOBs(FieldsblobsExample example) {
        List list = getSqlMapClientTemplate().queryForList("FIELDSBLOBS.selectByExampleWithBLOBs", example);
        return list;
    }
     ...
     * @mbg.generated Sat Mar 25 03:13:53 CST 2017
     */
    public List selectByExampleWithoutBLOBs(FieldsblobsExample example) {
        List list = getSqlMapClientTemplate().queryForList("FIELDSBLOBS.selectByExample", example);
        return list;
    }
