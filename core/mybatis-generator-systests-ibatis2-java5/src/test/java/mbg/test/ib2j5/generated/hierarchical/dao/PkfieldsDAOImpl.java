...
public class PkfieldsDAOImpl extends SqlMapClientDaoSupport implements PkfieldsDAO {
     ...
     * @mbg.generated Sat Mar 25 03:24:02 CST 2017
     */
    public long countByExample(PkfieldsExample example) {
        Long count = (Long)  getSqlMapClientTemplate().queryForObject("PKFIELDS.countByExample", example);
        return count;
    }
    ...
    public List<Pkfields> selectByExample(PkfieldsExample example) {
        List<Pkfields> list = getSqlMapClientTemplate().queryForList("PKFIELDS.selectByExample", example);
        return list;
    }
