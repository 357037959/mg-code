...
public class PkfieldsDAOImpl implements PkfieldsDAO {
    ...
    public List<Pkfields> selectByExample(PkfieldsExample example) throws SQLException {
        List<Pkfields> list = sqlMapClient.queryForList("PKFIELDS.selectByExample", example);
        return list;
    }
