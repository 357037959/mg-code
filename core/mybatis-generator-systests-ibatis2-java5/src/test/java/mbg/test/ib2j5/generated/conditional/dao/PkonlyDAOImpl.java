...
public class PkonlyDAOImpl implements PkonlyDAO {
    ...
    public List<PkonlyKey> selectByExample(PkonlyExample example) throws SQLException {
        List<PkonlyKey> list = sqlMapClient.queryForList("PKONLY.selectByExample", example);
        return list;
    }
